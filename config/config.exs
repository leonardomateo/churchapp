...
config :churchapp, ChurchappWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ChurchappWeb.ErrorHTML, json: ChurchappWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Churchapp.PubSub,
  live_view: [signing_salt: "NrQlsn8L"]
...
config :churchapp, Churchapp.Mailer, adapter: Swoosh.Adapters.Local
