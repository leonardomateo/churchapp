defmodule ChurchappWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChurchappWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChurchappWeb.Gettext, "errors", msg, opts)
    end
  end
