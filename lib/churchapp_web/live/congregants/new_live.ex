defmodule ChurchappWeb.CongregantsLive.NewLive do
  ...
  def render(assigns) do
    ...
    <div class="max-w-4xl mx-auto">
      <div class="mb-6">
        <.link navigate={~p"/congregants"} class="text-gray-400 hover:text-white flex items-center mb-4 transition-colors">
          <.icon name="hero-arrow-left" class="h-4 w-4 mr-2" /> Back to List
        </.link>
        <h2 class="text-2xl font-bold text-white">Add New Member</h2>
        <p class="text-gray-500 mt-1">Fill in the details to create a new church member record.</p>
      </div>
      ...
      <div class="bg-dark-800 shadow-xl rounded-lg border border-dark-700 overflow-hidden">
        <.form for={@form} phx-change="validate" phx-submit="save">
          ...
          <div class="px-6 py-4 bg-dark-700/50 border-t border-dark-700 flex justify-end space-x-3">
            <.link navigate={~p"/congregants"} class="px-4 py-2 border border-dark-700 rounded-md shadow-sm text-sm font-medium text-gray-300 bg-dark-800 hover:bg-dark-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors">
              Cancel
            </.link>
