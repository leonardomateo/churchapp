defmodule ChurchappWeb.ContributionsLive.EditLive do
  ...
  def mount(%{"id" => id}, _session, socket) do
    ...
    case Chms.Church.get_contribution_by_id(id, actor: actor) do
      {:ok, contribution} ->
        ...
        {:ok,
         socket
         |> assign(:page_title, "Edit Contribution")
         |> assign(:form, form)
  ...
  def render(assigns) do
    ...
    <div class="max-w-4xl mx-auto">
      <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-white">Edit Contribution</h2>
                  ...
                  <div class="mt-1 flex gap-2">
                    <div class="flex-1">
                      <.live_component
                        ...
                        id="contribution-type-selector-edit"
