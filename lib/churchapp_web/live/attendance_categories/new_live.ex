defmodule ChurchappWeb.AttendanceCategoriesLive.NewLive do
  use ChurchappWeb, :live_view

  alias Chms.Church.AttendanceCategories
  ...
  def mount(_params, _session, socket) do
    ...
    socket =
      socket
      |> assign(:page_title, "New Attendance Category")
      |> assign(:form, form)
  ...
  def handle_event("save", %{"form" => params}, socket) do
    case Form.submit(socket.assigns.form.source, params: params) do
      {:ok, category} ->
        {:noreply,
         socket
         |> put_flash(:info, "Category \"#{category.name}\" created successfully")
      ...
      <div class="max-w-2xl mx-auto">
        <div class="mb-6">
          ...
          <p class="mt-1 text-sm text-gray-400">
            Add a new category for tracking attendance
          </p>
        </div>
