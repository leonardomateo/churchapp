defmodule ChurchappWeb.MinistryFundsLive.EditLive do
  ...
  def mount(%{"id" => id}, _session, socket) do
    ...
    case Ash.get(MinistryFunds, id, actor: actor) do
      {:ok, ministry_fund} ->
        form =
          ministry_fund
        ...
        socket =
          ...
          |> assign(:transaction_type, ministry_fund.transaction_type)
    ...
    case Form.submit(socket.assigns.form, params: params_with_type) do
      {:ok, _ministry_fund} ->
        {:noreply,
         ...
         |> push_navigate(to: ~p"/ministry-funds/#{socket.assigns.ministry_fund}")}
  ...
  def render(assigns) do
    ...
    <div class="max-w-4xl mx-auto">
      <div class="mb-6">
        <.link
          navigate={~p"/ministry-funds/#{@ministry_fund}"}
        ...
        <p class="mt-1 text-gray-500">
          Update the transaction details for {@ministry_fund.ministry_name}.
        </p>
      </div>

      <div class="bg-dark-800 shadow-xl rounded-lg border border-dark-700 overflow-hidden">
        <.form for={@form} phx-change="validate" phx-submit="save" id="ministry-fund-edit-form">
