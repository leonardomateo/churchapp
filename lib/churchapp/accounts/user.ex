  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender Churchapp.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource Churchapp.Accounts.Token
      signing_secret Churchapp.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender Churchapp.Accounts.User.Senders.SendPasswordResetEmail
